 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/customer}Customer_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<CustomerFilter> filter;
     ...
     * 
     */
    public List<CustomerFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<CustomerFilter>();
        }
        return this.filter;
    }
