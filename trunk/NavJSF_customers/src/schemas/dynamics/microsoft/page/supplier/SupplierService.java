 ...
 * 
 */
@WebServiceClient(name = "Supplier_Service", targetNamespace = "urn:microsoft-dynamics-schemas/page/supplier", wsdlLocation = "http://localhost:7047/DynamicsNAV/WS/Page/Supplier")
    ...
    extends Service
{
    ...
    private final static QName SUPPLIERSERVICE_QNAME = new QName("urn:microsoft-dynamics-schemas/page/supplier", "Supplier_Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7047/DynamicsNAV/WS/Page/Supplier");
     ...
     * 
     * @return
     *     returns SupplierPort
     */
    @WebEndpoint(name = "Supplier_Port")
    public SupplierPort getSupplierPort() {
        return super.getPort(new QName("urn:microsoft-dynamics-schemas/page/supplier", "Supplier_Port"), SupplierPort.class);
    }
     ...
     */
    @WebEndpoint(name = "Supplier_Port")
    public SupplierPort getSupplierPort(WebServiceFeature... features) {
        return super.getPort(new QName("urn:microsoft-dynamics-schemas/page/supplier", "Supplier_Port"), SupplierPort.class, features);
    }
