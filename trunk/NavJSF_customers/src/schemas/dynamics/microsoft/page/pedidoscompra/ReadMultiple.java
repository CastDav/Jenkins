 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/pedidoscompra}PedidosCompra_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<PedidosCompraFilter> filter;
     ...
     * {@link PedidosCompraFilter }
     * 
     * 
     */
    public List<PedidosCompraFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<PedidosCompraFilter>();
        }
        return this.filter;
    }
