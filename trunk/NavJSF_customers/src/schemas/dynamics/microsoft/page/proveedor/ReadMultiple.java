 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/proveedor}Proveedor_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<ProveedorFilter> filter;
     ...
     * {@link ProveedorFilter }
     * 
     * 
     */
    public List<ProveedorFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<ProveedorFilter>();
        }
        return this.filter;
    }
