...
/**
 * <p>Java class for OrderInformation_Fields.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="OrderInformation_Fields">
 ...
 * 
 */
@XmlType(name = "OrderInformation_Fields")
@XmlEnum
public enum OrderInformationFields {
    ...
    OrderInformationFields(String v) {
        value = v;
    }
    ...
    public static OrderInformationFields fromValue(String v) {
        for (OrderInformationFields c: OrderInformationFields.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
