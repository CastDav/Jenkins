 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/orderinformation}OrderInformation_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<OrderInformationFilter> filter;
     ...
     * {@link OrderInformationFilter }
     * 
     * 
     */
    public List<OrderInformationFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<OrderInformationFilter>();
        }
        return this.filter;
    }
