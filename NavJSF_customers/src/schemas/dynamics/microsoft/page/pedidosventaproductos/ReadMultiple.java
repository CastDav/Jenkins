 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/pedidosventaproductos}PedidosVentaProductos_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<PedidosVentaProductosFilter> filter;
     ...
     * {@link PedidosVentaProductosFilter }
     * 
     * 
     */
    public List<PedidosVentaProductosFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<PedidosVentaProductosFilter>();
        }
        return this.filter;
    }
