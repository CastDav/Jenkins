 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/loginweblist}LoginWebList_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<LoginWebListFilter> filter;
     ...
     * {@link LoginWebListFilter }
     * 
     * 
     */
    public List<LoginWebListFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<LoginWebListFilter>();
        }
        return this.filter;
    }
