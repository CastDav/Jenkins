...
/**
 * <p>Java class for Productos_Fields.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="Productos_Fields">
 ...
 * 
 */
@XmlType(name = "Productos_Fields")
@XmlEnum
public enum ProductosFields {
    ...
    public static ProductosFields fromValue(String v) {
        for (ProductosFields c: ProductosFields.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
