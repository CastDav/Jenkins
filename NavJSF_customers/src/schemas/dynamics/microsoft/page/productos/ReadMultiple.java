 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/productos}Productos_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<ProductosFilter> filter;
     ...
     * {@link ProductosFilter }
     * 
     * 
     */
    public List<ProductosFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<ProductosFilter>();
        }
        return this.filter;
    }
