...
/**
 * <p>Java class for Supplier_Fields.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="Supplier_Fields">
...
public enum SupplierFields {
    ...
    public static SupplierFields fromValue(String v) {
        for (SupplierFields c: SupplierFields.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
