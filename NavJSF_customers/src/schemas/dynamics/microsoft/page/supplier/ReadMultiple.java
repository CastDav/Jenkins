 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/supplier}Supplier_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<SupplierFilter> filter;
     ...
     * 
     */
    public List<SupplierFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<SupplierFilter>();
        }
        return this.filter;
    }
