 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/purchaseorder}PurchaseOrder_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<PurchaseOrderFilter> filter;
     ...
     * {@link PurchaseOrderFilter }
     * 
     * 
     */
    public List<PurchaseOrderFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<PurchaseOrderFilter>();
        }
        return this.filter;
    }
