 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/product}Product_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<ProductFilter> filter;
    ...
    public List<ProductFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<ProductFilter>();
        }
        return this.filter;
    }
