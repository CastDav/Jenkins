 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/pedidosventa}PedidosVenta_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<PedidosVentaFilter> filter;
     ...
     * {@link PedidosVentaFilter }
     * 
     * 
     */
    public List<PedidosVentaFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<PedidosVentaFilter>();
        }
        return this.filter;
    }
